// nativeBridge.js
//
// Owns the single native-messaging connection to the Java bridge process
// (bridge/JabExtBridge.java, host name "jabext_bridge"). The bridge
// binds one loopback HTTP port and writes one discovery file per OS
// process; if two extension modules each called `connectNative`
// independently, the browser would spawn two bridge processes that race
...
/// the bridge process no-ops when its port is already alive.
